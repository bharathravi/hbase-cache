...
public interface HFileScanner {
  // TODO(bharath): We eventually end up at this scanner, and it does the HFile reading.
  // RegionScanner -> StoreScanners -> (MemstoreScanner and StoreFileScanner),
  // StoreFileScanner->HFileScanner
  /**
